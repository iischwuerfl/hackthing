...
export class InitiativeComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Initiative) {
        return item.id;
    }
    registerChangeInInitiatives() {
        this.eventSubscriber = this.eventManager.subscribe('initiativeListModification', (response) => this.reset());
    }
